...
// Shown instead of the dashboard whenever must_change_password is true --
// an Admin created this farmer with a temporary password, and the farmer
// must set their own before doing anything else.
export default function ForceChangePassword() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess(true);
      // Brief pause so the confirmation is actually visible before
      // navigating on -- otherwise this looked like nothing happened.
